[![Latest Stable Version](https://poser.pugx.org/czt/wechat-developer/v/stable)](https://packagist.org/packages/czt/wechat-developer) 
[![Latest Unstable Version](https://poser.pugx.org/czt/wechat-developer/v/unstable)](https://packagist.org/packages/czt/wechat-developer) 
[![Total Downloads](https://poser.pugx.org/czt/wechat-developer/downloads)](https://packagist.org/packages/czt/wechat-developer) 
[![License](https://poser.pugx.org/czt/wechat-developer/license)](https://packagist.org/packages/czt/wechat-developer)

WeChatDeveloper for PHP
----
* WeChatDeveloper 是基于 [wechat-php-sdk](https://github.com/czt/wechat-php-sdk) 重构，优化并完善；
...
* Gitee 托管地址：https://gitee.com/niubea/wechat-developer
* GitHub 托管地址：https://github.com/niubea/wechat-developer
...
```shell
# 首次安装 线上版本（稳定）
composer require czt/wechat-developer

# 首次安装 开发版本（开发）
composer require czt/wechat-developer dev-master

# 更新 WeChatDeveloper
composer update czt/wechat-developer
```
